...
// RF output power = 0 dBm
// RX filterbandwidth = 101.562500 kHz
// Deviation = 19 kHz -->50kHz
// Datarate = 38.383484 kBaud-->55.5kBaud
// Modulation = (1) GFSK
// Manchester enable = (0) Manchester disabled
...
RF_SETTINGS rfSettings = {
    ...
    0x3B,  // FREQ0         Frequency Control Word, Low Byte
    0xCB,   // MDMCFG4   Modem configuration.
    0x18,   // MDMCFG3   Modem configuration.
	0x93,   // MDMCFG2   Modem configuration.
    0x22,   // MDMCFG1   Modem configuration.
    0xF8,   // MDMCFG0   Modem configuration.
    0x00,   // CHANNR    Channel number.
    0x48,   // DEVIATN   Modem deviation setting (when FSK modulation is enabled).
    0x56,   // FREND1    Front end RX configuration.
    0x10,   // FREND0    Front end TX configuration.
    0x18,   // MCSM0     Main Radio Control State Machine configuration.
    0x16,   // FOCCFG    Frequency Offset Compensation Configuration.
